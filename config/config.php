...
require_once('../../lib/SimpleSAML/Logger.php');
$config = array(
    /**
	 ...
	 * This directory wll be created if it doesn't exist.
     */
    ...
    /**
     * This is a secret salt used when it needs to generate a secure hash
     ...
     * also as the technical contact.
     */
    
    'technicalcontact_name' => 'Administrador',
    'technicalcontact_email' => 'Administrador@ejemplo.org',

    /*
     * The timezone of the server. This option should be set to the timezone you want
     * this packet to report the time in. The default is to guess the timezone based
    ...
    'authproc.idp' => array(
         ...
         * by checking the 'attributes' on IdP hosted and SP remote.
         */
    ...
    'memcache_store.servers' => array(
        array(
            array('hostname' => 'simplesaml2.local:8081'),
        ),
    ),
