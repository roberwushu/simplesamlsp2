...
require_once('../../lib/SimpleSAML/Configuration.php');
require_once('../../lib/SimpleSAML/Auth/Source.php');
require_once('../../lib/SimpleSAML/Store.php');
require_once('../../lib/SimpleSAML/Utils/Crypto.php');
require_once('../../lib/SimpleSAML/Utils/Config/Metadata.php');
require_once('../../lib/SimpleSAML/Metadata/SAMLBuilder.php');
require_once('../../lib/SimpleSAML/Metadata/Signer.php');
/*
foreach (glob("../../lib/SimpleSAML/*") as $filename)
{
    echo $filename."<br>";
    //include $filename;
}*/
...
$spconfig = $source->getLocalConfig();
...
$slol='http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; 
$slol=substr($slol,0, -12).'return.php';  
...
//SimpleSAML_Module::getModuleURL('saml/sp/saml2-acs.php/'.$sourceId);
//SimpleSAML_Module::getModuleURL('saml/sp/saml1-acs.php/'.$sourceId.'/artifact');
//SimpleSAML_Module::getModuleURL('saml/sp/saml2-acs.php/'.$sourceId);
...
if (array_key_exists('output', $_REQUEST) && $_REQUEST['output'] == 'xhtml') {
    ...
    $t->data['metadataflat'] = '$localConfig['.var_export($entityId, true).'] = '.var_export($metaArray20, true).';';
    $t->data['metaurl'] = $source->getlocalConfigURL();
    $t->show();
} else { 
    //samlmetadata+xml
