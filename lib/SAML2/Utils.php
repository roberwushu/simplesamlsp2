...
namespace SAML2;
require_once('../../lib/RobRichards/XMLSecLibs/XMLSecEnc.php');
require_once('../../lib/RobRichards/XMLSecLibs/XMLSecurityDSig.php');
require_once('../../lib/RobRichards/XMLSecLibs/XMLSecurityKey.php');
require_once('../../lib/SAML2/XML/ds/KeyInfo.php');
require_once('../../lib/SAML2/XML/ds/X509Certificate.php');
require_once('../../lib/SAML2/XML/ds/X509Data.php');
require_once('../../lib/SAML2/XML/md/KeyDescriptor.php');

use lib\RobRichards\XMLSecLibs\XMLSecEnc;
use lib\RobRichards\XMLSecLibs\XMLSecurityDSig;
use lib\RobRichards\XMLSecLibs\XMLSecurityKey;
...
class Utils
{
    ...
    public static function validateSignature(array $info, \XMLSecurityKey $key)
    {
        ...
        if ($key->type === \XMLSecurityKey::RSA_SHA512 && $algo !== $key->type) {
    ...
    public static function addString(\DOMElement $parent, $namespace, $name, $value)
    {
        ...
        if($name=='saml:AuthnContextClassRef')
            {
         ...
         if($name=='saml2:Issuer')
        {         
                $n->setAttribute('Format', Constants::NAMEID_ENTITY);
        }
