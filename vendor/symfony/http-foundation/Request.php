...
class Request
{
     ...
     *
     *  * http://simplesaml2.local:8081/mysite              returns an empty string
     *  * http://simplesaml2.local:8081/mysite/about        returns '/about'
     *  * http://simplesaml2.local:8081/mysite/enco%20ded   returns '/enco%20ded'
     *  * http://simplesaml2.local:8081/mysite/about?var=1  returns '/about'
     *
     ...
     *
     *  * http://simplesaml2.local:8081/index.php         returns an empty string
     *  * http://simplesaml2.local:8081/index.php/page    returns an empty string
     *  * http://simplesaml2.local:8081/web/index.php     returns '/web'
     *  * http://simplesaml2.local:8081/we%20b/index.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
