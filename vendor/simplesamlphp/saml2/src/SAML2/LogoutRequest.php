...
class LogoutRequest extends Request
{
    ...
    /**
     * The value of the destinaton of the Logout Request.
     *
     * @var \SAML2\XML\saml\NameID
     */
    private $destination;
    ...
    /**
     * Set the destinarion of this request.
     *
     * @param string $destination The destination of this request.
     */
    ...
    {
        $root = parent::toUnsignedXMLLogOut();
        ...
        if ($this->notOnOrAfter === null) {
            ...
            $root->setAttribute('Reason', 'urn:oasis:names:tc:SAML:2.0:logout:user');
        if ($this->encryptedNameId === null) {
            $this->nameId->toXML($root);
        } else {
